 ...
 * @author prometheus
 */
public class VentanaCrearServicio extends VentanaGeneral {

    /**
     * Creates new form VentanaCrearServicio
     */
    public VentanaCrearServicio(String title, ActionListener accion, MouseListener ml) {
        initComponents();
        topMenu.setMenuFunctions(this, ml, title);
